  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "bg-muted pointer-events-none block size-5 rounded-full ring-0 transition-transform data-[state=checked]:translate-x-5.25 data-[state=unchecked]:translate-x-0.25"
        )}
      />
    </SwitchPrimitive.Root>
  );
